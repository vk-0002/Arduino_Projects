...
const char* ssid = "Lokhandenet"; // SSID i.e. Service Set Identifier is the name of your WIFI
const char* password = "ajay@don123"; // Your Wifi password, in case you have open network comment the whole statement.
